		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				var datetimepicker = $('<div '+(options.id?'id="'+options.id+'"':'')+' '+(options.style?'style="'+options.style+'"':'')+' class="xdsoft_datetimepicker xdsoft_noselect '+options.className+'"></div>'),
					...
					mounth_picker = $('<div class="xdsoft_mounthpicker"><em></em><div class="xdsoft_prev"></div><div class="xdsoft_today_button"></div><div class="xdsof_box"><div class="xdsoft_label xdsoft_month"><span></span><i>年</i></div><div class="xdsoft_label xdsoft_year"><span></span><i>月</i></div></div><div class="xdsoft_next"></div><div class="rIc"></div></div>'),
